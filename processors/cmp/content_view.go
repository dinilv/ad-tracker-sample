...
func SubscribeContentView(msg map[string]string) *model.TrackLog {
	...
	default:
		...
		go logger.ErrorLogger("On Not Processed", "ContentViewSubscriber:"+strconv.Itoa(track.Activity), "Switch case failed")

	}
	if recover() != nil {
		log.Println("Something Went Wrong :-()")
		go logger.ErrorLogger("On recover", "ContentViewSubscriber", "Switch case failed")
	}
